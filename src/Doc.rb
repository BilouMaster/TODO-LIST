...
link_method_documentation 'Command.angle_xy', 
  'Renvoie l\' angle x->y entre deux points, défini entre 0 et 360 degrés',
  {
    ...
    :ya => ["Coordonnées Y du point A", :Fixnum],
    :xb => ["Coordonnées X du point B", :Fixnum],
    :yb => ["Coordonnées Y du point B", :Fixnum],
...
register_command :standard, 'Command.event_name' 
...
if $TEST
  DocGenerator.markdown("../wiki/doc")
end
